...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({
    ...
    const variants = {
        primary: 'bg-button-1 text-button-1 hover:bg-blue-600 active:bg-blue-700 focus:ring-blue-500',
        secondary: 'bg-gray-200 text-gray-800 hover:bg-gray-300 active:bg-gray-400 focus:ring-gray-300',
        outline:'border border-gray=300 text-gray-700 hover:bg-transparent hover:bg-gray-50 active:bg-gray-100 focus:ring-gray-700',
    ...
    const LoadingSpinner = ()=>(
        ...
        >
            ...
            <path className='opacity-75' fill = "currentColor" d = "M4 12a8 8 0 018-8V0C5.3733 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"/>
        </svg>
    )
    ...
    return (
        <button
            ...
            <span className = {loading ? 'opacity-75' : ''}>{children}
            </span>
        </button>
